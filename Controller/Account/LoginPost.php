...
namespace Kitchen\News\Controller\Account;
...
class LoginPost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        $is_approve = $customer->getCustomCustomerIsapprove();

        if(!$is_approve){
            $this->messageManager->addErrorMessage(__('Account is not approve ask admin to approve your account'));
